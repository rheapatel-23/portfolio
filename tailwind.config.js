  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "neon-lg": "0 0 40px rgba(212, 255, 0, 0.5)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "slide-in-left": "slide-in-left 0.6s cubic-bezier(0.19, 1, 0.22, 1) forwards",
        "slide-in-right": "slide-in-right 0.6s cubic-bezier(0.19, 1, 0.22, 1) forwards",
